...
<head>
    ...
    <title>Futuristic Cousine - Papas Horneadas</title>
...
<!--------------------------------PORTADA RECERTA----------------------------->
        ...
        <div class="contenedor-receta">
            <img src="../img/receta-buscada-6.jpg" alt="carne-asada" class="imagen-receta">
...
<!------------------------------FOOTER---------------------------------------->
    ...
    <script src="../JS/papas-horneadas.js"></script>
