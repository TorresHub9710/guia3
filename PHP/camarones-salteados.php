...
<head>
    ...
    <title>Futuristic Cousine - Camarones Salteados</title>
...
<!--------------------------------PORTADA RECERTA----------------------------->
        ...
        <div class="contenedor-receta">
            <img src="../img/receta-buscada-5.jpg" alt="carne-asada" class="imagen-receta">
...
<!------------------------------FOOTER---------------------------------------->
    ...
    <script src="../JS/camarones-salteados.js"></script>
