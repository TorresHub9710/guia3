...
<head>
    ...
    <title>Futuristic Cousine - Pechuga a la Plancha</title>
...
<!--------------------------------PORTADA RECERTA----------------------------->
        ...
        <div class="contenedor-receta">
            <img src="../img/receta-buscada-3.jpg" alt="carne-asada" class="imagen-receta">
...
<!------------------------------FOOTER---------------------------------------->
    ...
    <script src="../JS/pechuga-plancha.js"></script>
