...
<head>
    ...
    <title>Futuristic Cousine - Ensalada Diaria</title>
...
<!--------------------------------PORTADA RECERTA----------------------------->
        ...
        <div class="contenedor-receta">
            <img src="../img/receta-buscada-4.jpg" alt="carne-asada" class="imagen-receta">
...
<!------------------------------FOOTER---------------------------------------->
    ...
    <script src="../JS/ensalada-diaria.js"></script>
